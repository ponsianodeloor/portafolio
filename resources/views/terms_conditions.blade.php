        ...
        <div class="container">
            ...
            <div class="section-title">
                ...
                <p>
                    ...
                    El sitio web utiliza cookies para ayudar a personalizar tu experiencia en línea. Al acceder a ponsianodeloor.com, aceptaste utilizar las cookies necesarias.
                ...
                <p>
                    A menos que se indique lo contrario, Ponsiano De Loor y/o sus licenciantes poseen los derechos de propiedad intelectual de todo el material en ponsianodeloor.com. Todos los derechos de propiedad intelectual son reservados. Puedes acceder desde ponsianodeloor.com para tu uso personal sujeto a las restricciones establecidas en estos términos y condiciones.

                    No debes:

                    Copiar o volver a publicar material de ponsianodeloor.com
                    Vender, alquilar o sublicenciar material de ponsianodeloor.com
                    Reproducir, duplicar o copiar material de ponsianodeloor.com
                    Redistribuir contenido de ponsianodeloor.com

                    Este acuerdo comenzará el fecha presente.

                    Partes de este sitio web ofrecen a los usuarios la oportunidad de publicar e intercambiar opiniones e información en determinadas áreas. Ponsiano De Loor no filtra, edita, publica ni revisa los comentarios antes de su presencia en el sitio web. Los comentarios no reflejan los puntos de vista ni las opiniones de Ponsiano De Loor, sus agentes y/o afiliados. Los comentarios reflejan los puntos de vista y opiniones de la persona que publica. En la medida en que lo permitan las leyes aplicables, Ponsiano De Loor no será responsable de los comentarios ni de ninguna responsabilidad, daños o gastos causados ​​o sufridos como resultado de cualquier uso o publicación o apariencia de comentarios en este sitio web.

                    Ponsiano De Loor se reserva el derecho de monitorear todos los comentarios y eliminar los que puedan considerarse inapropiados, ofensivos o que incumplan estos Términos y Condiciones.
                    ...
                    Por la presente, otorgas a Ponsiano De Loor una licencia no exclusiva para usar, reproducir, editar y autorizar a otros a usar, reproducir y editar cualquiera de tus comentarios en todas y cada una de las formas, formatos, o medios.
                </p>
                <br>
                <h3>Hipervinculos a nuestro contenido</h3>
                <p>
                    ...
                    Si eres una de las organizaciones enumeradas en el párrafo 2 y estás interesada en vincularte a nuestro sitio web, debes informarnos enviando un correo electrónico a Ponsiano De Loor. Incluye tu nombre, el nombre de tu organización, la información de contacto, así como la URL de tu sitio, una lista de las URL desde las que tienes la intención de vincular a nuestro sitio web y una lista de las URL de nuestro sitio a las que te gustaría acceder. Espera 2-3 semanas para recibir una respuesta.
                    ...
                    No se permitirá el uso del logotipo de Ponsiano De Loor u otro material gráfico para vincular sin un acuerdo de licencia de marca comercial.
